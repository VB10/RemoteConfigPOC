...
open class NetworkManager {
    ...
    public func getData(_ url: String, fileURL: URL? = nil, timeout: Double? = nil, headers: [String:String], parameters : Parameters? = nil,success: @escaping DownloadResult,fail: @escaping Fail) -> DownloaderRequest
    {
        let downloadRequest = DownloaderRequest(url: url, fileURL: fileURL, method: HTTPMethod.get, timeout: timeout, headers:headers,parameters:parameters)
